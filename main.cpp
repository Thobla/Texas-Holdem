...
int main()
{
    ...
    std::cout << "p1, card1->value: " <<(*p1.hand[0])->value << "\n";
    std::cout << "p1, card2->value: " <<(*p1.hand[1])->value << "\n";
    ...
    std::cout << "table card-values: " << (*table.table[0])->value << (*table.table[1])->value << (*table.table[2])->value
<< (*table.table[3])->value << (*table.table[4])->value << "\n";

    std::cout << "deck card 0,1,2,3 and 4 - values " << myDeck.deck[0] -> value <<myDeck.deck[1]-> value <<myDeck.deck[2]-> value <<myDeck.deck[3] -> value <<myDeck.deck[4]-> value << "\n";
}
